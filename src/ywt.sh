...
# Build date: 2024-03-12T21:33:59+00:00
# Build ID: 1cfbffe50e3b5273c70cf5a58d6dd49dabf404ba
# Build branch: main
# Build tag: Unknown
# Build commit: 1cfbffe
# Build author: Raphael Carlos Rego <raphaelcarlosr@gmail.com>
# Build message: Fix logger success function and update process function
# {"file":"/workspace/rapd-shell/sdk/lib/builder.ywt.sh","expires_at":"31/12/1999","size":"12K","md5":"56c99e04804d2689093ed970c8964015","sha1":"d5dbb42f164f8e8fb782b3d4b75bc281c5f1ef48","sha256":"3bd4867fb7c3e59ce2ec98d5641a80e10dcf16c41fd13a7e37fdf300b390901c","sha512":"e0dba6c6dc32273fa442f3077cad28d89fa93612f36ef69db6055d17407c5258d77c93a29e0c8d208c70cb1ff222d08aea0e40158e902ec5860297e273ad8831","created_at":"2024-03-12T21:33:59+00:00","binary":false}
...
builder() {
    ...
    __build_file() {
        ...
        cp -f "${FILE}.x" "${BIN}/$FILENAME"        # /bin/file
        cp -f "${FILE}.x" "${FILE_DIR}/$FILENAME"        # /bin/file
