...
# Build date: 2024-04-04T01:21:12+00:00
# Build ID: 9dfb20ea1e52a2088dabcc3f55151a5037c2558c
# Build branch: main
# Build tag: Unknown
# Build commit: 9dfb20e
# Build author: Raphael C. Rego <raphaelcarlosr@gmail.com>
# Build message: Refactor app-info and scan functions
# <app-info.ywt.sh>
ywt:info() {
    package() {
