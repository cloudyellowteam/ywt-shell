...
# Build date: 2024-04-04T17:22:54+00:00
# Build ID: 333af6c37c3ec972e381aaf50a05b72365fa7eef
# Build branch: main
# Build tag: Unknown
# Build commit: 333af6c
# Build author: Raphael C. Rego <raphaelcarlosr@gmail.com>
# Build message: Update envsubst polyfill and rename ywt to ydk
# <app-info.ywt.sh>
ywt:info() {
    package() {
